                ...
                <div class="col-xl-12">
                    ...
                    <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                        <a href="{{route('room.create')}}" class="btn btn-primary mb-xxl-0 mb-4 "><i
                                class="fa fa-plus" aria-hidden="true"></i> Add room</a>
                    </div>
                                ...
                                <table
                                    ...
                                    @foreach($rooms  as $room)
                                        <tr>
                                            <td>
                                                <div class="guest-bx">
                                                    <img class="me-3 rounded"
                                                         ...
                                                         @foreach($room->roomTranslation as $rt)
                                                             alt="{{$rt->title}}"
                                                        @endforeach
                                                    >
                                                </div>
                                            ...
                                            <td class="job-desk">
                                                <div>
                                                        <span>{{$room->parentRoomType->roomTypeTranslation->first()->title}}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <span>{{$room->number_of_rooms}}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>
                                                <span
                                                    class="{{($room->status==1) ? 'text-success' : 'text-danger'}}">{{($room->status==1) ? 'ACTIVE' : 'INACTIVE'}}</span>
                                            </td>
                                            <td>
