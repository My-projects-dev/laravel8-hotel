                ...
                <div class="col-xl-12">
                    ...
                    <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                        <a href="{{route('chef.create')}}" class="btn btn-primary mb-xxl-0 mb-4 "><i
                                class="fa fa-plus" aria-hidden="true"></i> Add chef</a>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane active show" id="All">
                            <div class="table-responsive">
                                <table
                                    ...
                                    @foreach($chefs  as $chef)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="{{($chef->parentChef->status==1) ? 'text-success' : 'text-danger'}}">{{($chef->parentChef->status==1) ? 'ACTIVE' : 'INACTIVE'}}</span>
                                            </td>
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                           href="{{route('chef.edit',$chef->parentChef->id)}}">Edit</a>
                                                        <form
                                                            action="{{ route('chef.destroy',$chef->parentChef->id) }}"
                                                            method="Post">
                                                            @csrf
                                                            @method('DELETE')
                                ...
                                <div class="d-flex justify-content-center">{!! $chefs->links() !!}</div>
                            </div>
                        </div>
                    </div>
                </div>
