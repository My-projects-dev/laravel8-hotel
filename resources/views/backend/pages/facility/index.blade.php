                ...
                <div class="col-xl-12">
                    ...
                    <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                        <a href="{{route('facility.create')}}" class="btn btn-primary mb-xxl-0 mb-4 "><i
                                class="fa fa-plus" aria-hidden="true"></i> Add facility</a>
                    </div>
                                ...
                                <table
                                    ...
                                    @foreach($facilities  as $facility)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="{{($facility->parentFacility->status==1) ? 'text-success' : 'text-danger'}}">{{($facility->parentFacility->status==1) ? 'ACTIVE' : 'INACTIVE'}}</span>
                                            </td>
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                           href="{{route('facility.edit',$facility->parentFacility->id)}}">Edit</a>
                                                        <form
                                                            action="{{ route('facility.destroy',$facility->parentFacility->id) }}"
                                                            method="Post">
                                                            @csrf
                                                            @method('DELETE')
