                ...
                <div class="col-xl-12">
                    ...
                    <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                        <a href="{{route('near.create')}}" class="btn btn-primary mb-xxl-0 mb-4 "><i
                                class="fa fa-plus" aria-hidden="true"></i> Add near</a>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane active show" id="All">
                            <div class="table-responsive">
                                <table
                                    ...
                                    @foreach($nearbies  as $near)
                                        <tr>
                                            ...
                                            <td class="job-desk">
                                                <div>
                                                    <span>{{$near->button_title}}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="{{($near->parentNear->status==1) ? 'text-success' : 'text-danger'}}">{{($near->parentNear->status==1) ? 'ACTIVE' : 'INACTIVE'}}</span>
                                            </td>
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                           href="{{route('near.edit',$near->parentNear->id)}}">Edit</a>
                                                        <form
                                                            action="{{ route('near.destroy',$near->parentNear->id) }}"
                                                            method="Post">
                                                            @csrf
                                                            @method('DELETE')
                                ...
                                <div class="d-flex justify-content-center">{!! $nearbies->links() !!}</div>
                            </div>
                        </div>
                    </div>
                </div>
