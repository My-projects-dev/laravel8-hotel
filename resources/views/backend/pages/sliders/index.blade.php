                ...
                <div class="col-xl-12">
                    ...
                    <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                        <a href="{{route('slider.create')}}" class="btn btn-primary mb-xxl-0 mb-4 "><i
                                class="fa fa-plus" aria-hidden="true"></i> Add slider</a>
                    </div>
                                ...
                                <table
                                    ...
                                    @foreach($sliders  as $slider)
                                        <tr>
                                            ...
                                            <td><span
                                                    class="{{($slider->parentSlider->status==1) ? 'text-success' : 'text-danger'}}">{{($slider->parentSlider->status==1) ? 'ACTIVE' : 'INACTIVE'}}</span>
                                            </td>
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                           href="{{route('slider.edit',$slider->parentSlider->id)}}">Edit</a>
                                                        <form
                                                            action="{{ route('slider.destroy',$slider->parentSlider->id) }}"
                                                            method="Post">
                                                            @csrf
                                                            @method('DELETE')
