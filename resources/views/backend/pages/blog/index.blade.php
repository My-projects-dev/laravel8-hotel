                ...
                <div class="col-xl-12">
                    ...
                    <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                        <a href="{{route('blog.create')}}" class="btn btn-primary mb-xxl-0 mb-4 "><i
                                class="fa fa-plus" aria-hidden="true"></i> Add blog</a>
                    </div>
                                ...
                                <table
                                    ...
                                    @foreach($blogs  as $blog)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="{{($blog->parentBlog->status==1) ? 'text-success' : 'text-danger'}}">{{($blog->parentBlog->status==1) ? 'ACTIVE' : 'INACTIVE'}}</span>
                                            </td>
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                           href="{{route('blog.edit',$blog->parentBlog->id)}}">Edit</a>
                                                        <form
                                                            action="{{ route('blog.destroy',$blog->parentBlog->id) }}"
                                                            method="Post">
                                                            @csrf
                                                            @method('DELETE')
