                ...
                <div class="col-xl-12">
                    ...
                    <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                        <a href="{{route('roomtype.create')}}" class="btn btn-primary mb-xxl-0 mb-4 "><i
                                class="fa fa-plus" aria-hidden="true"></i> Add room type</a>
                    </div>
                                ...
                                <table
                                    ...
                                    @foreach($types as $type)
                                        <tr>
                                            ...
                                            <td><span
                                                    class="{{($type->parentRoomType->status==1) ? 'text-success' : 'text-danger'}}">{{($type->parentRoomType->status==1) ? 'ACTIVE' : 'INACTIVE'}}</span>
                                            </td>
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                           href="{{route('roomtype.edit',$type->parentRoomType->id)}}">Edit</a>
                                                        <form
                                                            action="{{ route('roomtype.destroy',$type->parentRoomType->id) }}"
                                                            method="Post">
                                                            @csrf
                                                            @method('DELETE')
