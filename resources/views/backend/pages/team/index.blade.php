                ...
                <div class="col-xl-12">
                    ...
                    <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                        <a href="{{route('team.create')}}" class="btn btn-primary mb-xxl-0 mb-4 "><i
                                class="fa fa-plus" aria-hidden="true"></i> Add team</a>
                    </div>
                                ...
                                <table
                                    ...
                                    @foreach($teams  as $team)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="{{($team->parentTeam->status==1) ? 'text-success' : 'text-danger'}}">{{($team->parentTeam->status==1) ? 'ACTIVE' : 'INACTIVE'}}</span>
                                            </td>
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                           href="{{route('team.edit',$team->parentTeam->id)}}">Edit</a>
                                                        <form
                                                            action="{{ route('team.destroy',$team->parentTeam->id) }}"
                                                            method="Post">
                                                            @csrf
                                                            @method('DELETE')
