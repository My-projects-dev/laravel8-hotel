                ...
                <div class="col-xl-12">
                    ...
                    <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                        <a href="{{route('menu.create')}}" class="btn btn-primary mb-xxl-0 mb-4 "><i
                                class="fa fa-plus" aria-hidden="true"></i> Add menu</a>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane active show" id="All">
                            <div class="table-responsive">
                                <table
                                    ...
                                    @foreach($menus  as $menu)
                                        <tr>
                                            ...
                                            <td class="job-desk">
                                                <div>
                                                    <span>{{$menu->button_title}}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="{{($menu->parentMenu->status==1) ? 'text-success' : 'text-danger'}}">{{($menu->parentMenu->status==1) ? 'ACTIVE' : 'INACTIVE'}}</span>
                                            </td>
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                           href="{{route('menu.edit',$menu->parentMenu->id)}}">Edit</a>
                                                        <form
                                                            action="{{ route('menu.destroy',$menu->parentMenu->id) }}"
                                                            method="Post">
                                                            @csrf
                                                            @method('DELETE')
                                ...
                                <div class="d-flex justify-content-center">{!! $menus->links() !!}</div>
                            </div>
                        </div>
                    </div>
                </div>
