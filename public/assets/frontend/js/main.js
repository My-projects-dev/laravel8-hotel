$(function () {
    ...
    $('.qty-plus-adult, .qty-plus-child, .qty-plus-infant, .qty-minus, .qty-minus-adult').on("click", function (e) {
    e.preventDefault();

    var maxAdults = $('#ticket-adult').data('adult');
    var guest = $('#ticket-children').data('child');
    var inputAdult = $('#ticket-adult').data('value');
    var inputChild = $('#ticket-children').data('value');
    var maxChildren = guest - inputAdult;
    var maxAdult = guest - inputChild;
    ...
    if (!isNaN(currentVal)) {
        ...
        if ($this.hasClass('qty-plus-adult') && currentVal < maxAdults  && currentVal < maxAdult) {
            value = currentVal + 1;
            isChanged = true;
        }

        if ($this.hasClass('qty-plus-child') && currentVal < maxChildren) {
            value = currentVal + 1;
            isChanged = true;
        }

        if ($this.hasClass('qty-plus-infant') && currentVal < 5) {
            value = currentVal + 1;
            isChanged = true;
        }

        if ($this.hasClass('qty-minus-adult') && currentVal > 1) {
            value = currentVal - 1;
            isChanged = true;
        }
    ...
    $('.qty-plus').add('.qty-minus').on("click", function (e) {
        ...
        if (!isNaN(currentVal)) {
            ...
            if ($this.hasClass('qty-plus') && currentVal < 22) {
                value = currentVal + 1;
                isChanged = true;
            }
